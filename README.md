...
<p>While vim themes can be installed manually (place <a href="https://github.com/haystackandroid/wonka/tree/master/colors">theme file</a> in <code class="highlighter-rouge">~/.vim/colors/</code>), a <strong>plugin helper</strong> is recommended.</p>
