" wonka, a vim colourscheme by haystackandroid
"
...
if &background ==# 'dark'
  ...
  let g:terminal_color_7 =  '#b5aca3'
  let g:terminal_color_8 =  '#8a8076'
  let g:terminal_color_9 =  '#b56f45'
  let g:terminal_color_10 = '#3b332c'
  let g:terminal_color_11 = '#756b61'
  let g:terminal_color_12 = '#9e958b'
  let g:terminal_color_13 = '#f0e6dd'
  ...
  let g:terminal_color_7 =  '#756b61'
  let g:terminal_color_8 =  '#9e958b'
  let g:terminal_color_9 =  '#e06a26'
  let g:terminal_color_10 = '#f0e6dd'
  let g:terminal_color_11 = '#b5aca3'
  let g:terminal_color_12 = '#8a8076'
  let g:terminal_color_13 = '#3b332c'
  let g:terminal_color_14 = '#d46a84'
  let g:terminal_color_15 = '#2b241d'
endif
...
if exists('g:wonkaCursorLineNr')
if g:wonkaCursorLineNr == 'off'
cal <sid>h('CursorLineNr'     , s:g4 , s:g1 , s:t4 , s:t1 , 'none'      , '')
endif
endif

" disable LineNr background altogether
if exists('g:wonkaLineNr')
if g:wonkaLineNr == 'off'
